...
public class FightGateway {
    ...
    public Collection<fr.pantheonsorbonne.ufr27.miage.dto.Pokemon> getRandomPokemonForFight(fr.pantheonsorbonne.ufr27.miage.dto.Pokemon pokemonDresseur) throws PokemonNotFoundException {
        ...
        pokemonFights.add( new fr.pantheonsorbonne.ufr27.miage.dto.Pokemon(randomPokemon.getIdPokemon(),randomPokemon.getPrix(),randomPokemon.getPrix()));
